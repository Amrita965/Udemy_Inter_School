...
urlpatterns = [
    ...
    path('students/<int:pk>/remove_course/<int:cid>/', RemoveStudentCourse.as_view(), name='remove_student_course'),  # new URL path for removing a course from a student's course list
]
